...
public class MorePresenter<V extends MoreContract.View> extends BasePresenter<V>
    ...
    public MorePresenter(ICommonAPIManager dataManager, SchedulerProvider schedulerProvider, CompositeDisposable compositeDisposable, SessionManager sessionManager, CartManager cartManager) {
