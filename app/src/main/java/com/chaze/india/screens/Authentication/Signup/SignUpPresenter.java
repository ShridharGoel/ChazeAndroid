...
public class SignUpPresenter<V extends SignUpContract.View> extends BasePresenter<V>
    ...
    @Inject
    public SignUpPresenter(ICommonAPIManager dataManager, SchedulerProvider schedulerProvider, CompositeDisposable compositeDisposable, SessionManager sessionManager, CartManager cartManager) {
